...
public class ShoppingCartErrorHandler {
    ...
    public ErrorResponse handleNotFoundException(NoProductsInShoppingCartException e) {
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ErrorResponse handleNotFoundException(DeactivateCartException e) {
        log.error("500 {}", e.getMessage());
        return ErrorResponse.builder()
                .cause(e.getCause())
                .stackTrace(Arrays.asList(e.getStackTrace()))
